...
@if (is_permited('browse_admins') == 1)
    ...
    @endpush
    <form action="{{ aurl('roles/create') }}" enctype="multipart/form-data" method="POST">
        @csrf
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('display_name_ar') }}" name="display_name_ar"
                            class="form-control" id="display_name_ar">
                    </div>

                    <div class="form-group">
                        <label class="floating-label" for="display_name_en">{{ trans('admin.Name En') }}</label>
                        <input type="text" value="{{ old('display_name_en') }}" name="display_name_en"
